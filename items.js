...
window.PACK_ITEMS = [
  ...
  {id:"springmealblueberry", cat:"food", role:"Trail meal", fit:"contain", img:"images/blueberry.jpg", name:"Endurance Meal, Blueberry", brand:"Spring Energy", oz:3.9, note:"REI lists 110 g (about 3.9 oz) per pouch, 310 cal. Vegan.", on:true},
  {id:"springmealmatcha", cat:"food", role:"Trail meal", fit:"contain", img:"images/matcha.jpg", name:"Endurance Meal, Matcha Berry", brand:"Spring Energy", oz:3.9, note:"REI lists 110 g (about 3.9 oz) per pouch, 310 cal. Vegan, with natural caffeine.", on:true},
  {id:"springgel", cat:"food", role:"Energy gel", fit:"contain", img:"images/gel.jpg", name:"Energy Gel, Speednut with Caffeine", brand:"Spring Energy", oz:1.8, note:"52 g net weight per packet, 50 mg caffeine.", on:true},
