...
window.PACK_ITEMS = [
  ...
  {id:"stove", cat:"food", role:"Stove", name:"Titanium Backpacking Stove", brand:"TOAKS", oz:1.6, note:"Stove only, 48 g. Uses isobutane-propane canisters (fuel not counted). Includes a storage bag.", on:true},
  {id:"pot", cat:"food", role:"Cook pot", name:"Titanium 750 ml Pot", brand:"TOAKS", oz:3.6, note:"Listed at 3.6 oz. Sold as pot, lid, and mesh sack. Weigh it to confirm what that includes.", on:true},
  {id:"cup", cat:"food", role:"Cup", name:"Light Titanium 450 ml Cup, Ultralight", brand:"TOAKS", oz:1.75, note:"48 g, no lid.", on:true},
