...
window.PACK_ITEMS = [
  ...
  {id:"stove", cat:"food", role:"Stove", fit:"contain", img:"images/stove.jpg", name:"Titanium Backpacking Stove", brand:"TOAKS", oz:1.6, note:"Stove only, 48 g. Uses isobutane-propane canisters (fuel not counted). Includes a storage bag.", on:true},
  ...
  {id:"cup", cat:"food", role:"Cup", fit:"contain", img:"images/cup.jpg", name:"Light Titanium 450 ml Cup, Ultralight", brand:"TOAKS", oz:1.75, note:"48 g, no lid.", on:true},
